...
def create_element_spectra_matrix_two(paramdict,trans_curve):
    """
  ...
  #  print "energy",energy  
    ...
    #
    xrf_list=find_xrf_peaks_list(energy,fitelements,fitting_range)
    if(include_escape):
        escape_list=find_escape_peak_list(energy,fitelements,fitting_range,detectortype)
    if(include_pileup):
        pileup_list=find_pileup_peak_list(energy,fitelements,fitting_range,pileup_cut_off)
